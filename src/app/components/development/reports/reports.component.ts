...
this.fromDate = this.form.value.fromDate;
    ...
    this.customer_id = this.form.value.customer_id;
    this.ticket_status = this.form.value.ticket_status;
    this._customerService.downloadAllTikitsReportList(this.fromDate, this.toDate, this.department_id, this.priority_id,this.ticket_category_id,'', this.searchKey,this.user_id,this.customer_id,this.ticket_status).subscribe({
      next: (blob: Blob) => {
